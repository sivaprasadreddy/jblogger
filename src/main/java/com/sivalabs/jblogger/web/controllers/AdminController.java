...
public class AdminController {
    ...
    public AdminController(
            EmailService emailService, BlogService blogService, PostService postService, TagService tagService) {
    ...
    public String dashboard(
            @RequestParam(value = "timePeriod", defaultValue = "TODAY") String timePeriod, Model model) {
    ...
    public String createPost(
            @Valid @ModelAttribute("post") Post post, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
            model.addAttribute("post", post);
            return "admin/newpost";
        }
    ...
    public String editPostForm(@PathVariable("postId") Long postId, HttpServletResponse response, Model model)
            throws IOException {
