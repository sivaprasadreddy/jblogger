...
create sequence tag_id_seq start with 100 increment by 1;
create sequence post_id_seq start with 100 increment by 1;
create sequence comment_id_seq start with 100 increment by 1;
create sequence pageview_id_seq start with 100 increment by 1;
...
create table posts (
    id bigint not null default post_id_seq.nextval,
...
create table pageviews (
    id bigint not null default pageview_id_seq.nextval,
